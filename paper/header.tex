...
\title{%
Are Design Summer Years a good enough test for future overheating in buildings?\\	% Line 1
%%% Please keep the \vspace{4pt} between lines in the title
\vspace{4pt}
\phantom{line} % Line 2 - If there is no second line then just put \phantom{Line 2} here
}
...
\author{
Mike Wood$^1$, Matthew Eames$^2$\\ % Line 4
$^1$University of Exeter, UK\\ % Line 5
***\\ % Line 6
***\\ % Line 7
***\\ % Line 8
} % Line 9 - Last line
