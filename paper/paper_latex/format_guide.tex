...
%%--------------------------------
% Custom configurations by mwetter@lbl.gov
...
\vspace{4pt}
for Building Simulation 2017 Conference % Line 2 - If there is no second line then just put \phantom{Line 2} here
}
...
$^1$BS Secretariat, Some Town, Some Country\\ % Line 5
...
This document explains how to prepare a paper for submission to the Building Simulation 2017 Conference. It also includes the instructions for submission and some other information.
...
Please \textbf{DO NOT} include page numbers. The paper must have 4 to 10 pages.
