...
(iii) what methods have been applied
...
(v) what is the lasting contribution of the submission.

Based on these results, we must be very careful about how we design weather files to test our buildings. We have shown that 
...
<!-- Related work from Process.st should go here. -->
